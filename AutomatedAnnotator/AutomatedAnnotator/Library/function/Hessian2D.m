...
[X,Y]   = ndgrid(-round(3*Sigma):round(3*Sigma)); % 7x7 / 19x19 / 31x31 / 43x43
...
% save( ['DGaussxx_' num2str(Sigma) 'sigma.txt'], 'DGaussxx', '-ascii');    
% save( ['DGaussxy_' num2str(Sigma) 'sigma.txt'], 'DGaussxy', '-ascii');    
% save( ['DGaussyy_' num2str(Sigma) 'sigma.txt'], 'DGaussyy', '-ascii');    
