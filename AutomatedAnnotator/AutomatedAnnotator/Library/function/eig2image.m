...
%
% This matrix is computed for each one of the pixels on the image. The
% maximum eigen values of the Hessian matrix will indicate if a point
% belongs to a ridge regardless of the ridge orientation. In order to
% evaluate how close the pixel is to the center of the ridge, the scalar
% product of the gradient with the eigen vector of the maximum eigen value
% is computed. Points in the center of the ridge will have this scalar
